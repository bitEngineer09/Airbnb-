    ...
    return (
        ...
        <div className='w-full h-screen'>
            ...
            <div className="listingPage1Container">
                <h1 className='text-[4.5rem] mt-[12rem] font-semibold text-center'>Which of these best describes your place?
                </h1>
                <div
                    className="
                        categoryContainer
            ...
            '>
                <div onClick={() => navigate('/')} className='underline cursor-pointer'>Back</div>
                <button
                    className='
                ...
                '
                    onClick={() => 
                        category ? navigate('/listingpage2') : alert("Please choose one of the categories.")
                    }
                >Next
                </button>
            </div>
