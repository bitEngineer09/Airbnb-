...
const ListingPage3 = () => {
    ...
    return (
        <div className='w-full h-screen'>
            ...
            <div>
                <h1 className='text-[4.5rem] font-semibold text-center mt-[12rem]'>Confirm Details & Address
                </h1>
            ...
            <div
                className='
                        ...
                        '>
                <div onClick={() => navigate('/listingpage2')} className='underline cursor-pointer'>Back
                </div>
                <button
                    type='submit'
                    className='
